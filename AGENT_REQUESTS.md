...
None — the 2026-06-29 stack-audit backlog was either shipped (P1 security hardening, dev-`.env`
prefill, worker ESLint + complexity gate, strict TS compiler flags, and type-checked ESLint) or
moved to GitHub issues #117–#121.
