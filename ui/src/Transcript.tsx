...
// while a past turn is viewed. The frozen viewer gets the turn's folded data model so path-bound
// CheckBox/Slider values render as seeded, not at defaults (#206).
