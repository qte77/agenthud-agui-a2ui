...
const CATALOG: CatalogEntry[] = [
  ...
  { name: "Button", description: "Clickable action trigger", usedInDemo: false },
  { name: "TextField", description: "Text input with label and validation", usedInDemo: false },
  { name: "CheckBox", description: "Boolean toggle with label", usedInDemo: false },
  { name: "Slider", description: "Numeric range input", usedInDemo: false },
  ...
  { name: "Tabs", description: "Tabbed content navigation", usedInDemo: false },
